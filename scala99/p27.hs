...
--    Example:
-- 
--    scala> group3(List("Aldo", "Beat", "Carla", "David", "Evi", "Flip",
--           "Gary", "Hugo", "Ida"))
--    res0: List[List[List[String]]] = List(List(List(Aldo, Beat), List(Carla,
--          David, Evi), List(Flip, Gary, Hugo, Ida)), ...
--
...
--           "Flip", "Gary", "Hugo", "Ida"))
--    res0: List[List[List[String]]] = List(List(List(Aldo, Beat), List(Carla,
--          David), List(Evi, Flip, Gary, Hugo, Ida)), ...
--
...
combinations 0 _      = [[]]
combinations _ []     = []
combinations k (x:xs) = combosWithX ++ combosWithoutX
  where combosWithX    = map (x:) $ combinations (k - 1) xs
        combosWithoutX = combinations k xs
